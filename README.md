...
📁 Repository Structure:
      ...
      │
      ├── Dataset/
      │   └── [hr_analytics_cleaned.csv](https://drive.google.com/file/d/1hrtSF1Uyj7-Sw8BN-L_Ze2DwcBwjwbLt/view?usp=drive_link)
      │
      ├── Python/
      │   └── [data_cleaning_mysql_connection.ipynb](https://drive.google.com/file/d/12pJJeaV3p-WEpYQSb-Kr4UlN8CcRcguW/view?usp=drive_link)
      │
      ├── SQL/
      │   └── [hr_analytics.sql](https://drive.google.com/file/d/12FCC4AQ9ri40QbKzedfGDpnZTq_QtFfI/view?usp=drive_link)
      │
      ├── PowerBI/
      │   └── [Workforce_Attrition_Analysis.pbix](https://drive.google.com/file/d/1XJtxGmHXm9-DI6Iqxc-N0QZVAolXxDE9/view?usp=drive_link)
      │
      ├── Images/
      │   └── [dashboard_preview.png](https://drive.google.com/file/d/1U3-_ohTqLbJYMQjuku3frXXrK9CUCWyU/view?usp=drive_link)
      │
      └── README.md
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
🚀 How to Use
